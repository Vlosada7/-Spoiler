...
import type { Clerk, ClerkOptions, ClientResource, DomainOrProxyUrl, LoadedClerk, PublishableKeyOrFrontendApi, RedirectOptions, SessionResource, UserResource } from '@clerk/types';
declare global {
    interface Window {
...
} & PublishableKeyOrFrontendApi & DomainOrProxyUrl;
